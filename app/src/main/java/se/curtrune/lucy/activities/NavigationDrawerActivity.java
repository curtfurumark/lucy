...
public class NavigationDrawerActivity extends AppCompatActivity {
    ...
    private void initComponents(){
        ...
        navigationView = findViewById(R.id.navigationDrawerActivity_navigationView);
        fragementContainer = findViewById(R.id.navigationDrawer_frameContainer);
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        log("...onOptionsItemSelected(MenuItem item)", item.getTitle().toString());
        if( item.getItemId() == R.id.navigationDrawer_graphFragment){
            navigate( new GraphFragment());
        }else{
            log("...unknown fragment");
        }
