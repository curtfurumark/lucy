...
public class CalenderWorker {
    ...
    /**
     *
     * @param yearMonth the yearMonth of interest
     * @param context, context the bloody context
     * @return a CalendarMonth with dates from first monday, till last sunday, '
     */
    public static  CalenderMonth getCalenderMonth(YearMonth yearMonth, Context context){
        ...
        calenderMonth.setCalenderDates(getCalenderDates(calenderMonth.getFirstDate(), calenderMonth.getLastDate(), context));
