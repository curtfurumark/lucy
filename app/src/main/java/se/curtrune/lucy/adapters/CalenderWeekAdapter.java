...
public class CalenderWeekAdapter extends RecyclerView.Adapter<CalenderWeekAdapter.ParentHolder> {
    ...
    private final List<CalenderDate> calenderDates;
    ...
    public void onBindViewHolder(@NonNull ParentHolder holder, int position) {
        ...
        MinimalItemAdapter minimalItemAdapter = new MinimalItemAdapter(dateItem.getItems());
    ...
    public class ParentHolder extends RecyclerView.ViewHolder{
        ...
        public ParentHolder(@NonNull View itemView) {
            ...
            log("...index", index);
            //CalenderDate calenderDate = calenderDates.get(itemView.getAdapterPosition());
            ...
            //layout.setOnClickListener(view->listener.onDateClick(calenderDate.getDate()));
        }
    }
}
