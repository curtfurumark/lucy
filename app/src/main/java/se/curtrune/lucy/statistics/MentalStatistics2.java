...
public class MentalStatistics2 {
    private LocalDate firstDate;
    private LocalDate lastDate;
    private List<Mental> mentals;
    private List<Mental> filtered;

    public MentalStatistics2(LocalDate firstDate, LocalDate lastDate, Context context) {
        log("MentalStatistics(LocalDate, LocalDate, Context)");
        this.firstDate = firstDate;
        this.lastDate = lastDate;
        init(context);
    }
    public MentalStatistics2(LocalDate date, Context context) {
        log("MentalStatistics(LocalDate, LocalDate, Context)");
        this.firstDate = date;
        this.lastDate = date;
        init(context);
